...
An advanced, multi-use Discord bot, made primarily for the CordCraft Discord server, GunjiCordia.

:copyright: (c) 2024 Tywrap Studios
...
__author__ = 'Tywrap Studios'
__license__ = 'MIT'
__copyright__ = 'Copyright 2024 Tywrap Studios'
__version__ = '1.6.1'
