...
botPing = f'<@{botId}>'
botVersion = 'CordCrafter 1.6.0 [POST PRODUCTION]'  # Interchangeable, please change for final release.
...
privacy_notion = 'https://tywrap-studios.notion.site/cordcrafter-bot-privacy-policy'
